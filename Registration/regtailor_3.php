	...
	<div class="main">
		<div class="main-w3l">
			...
			<div class="w3layouts-main">
				<br>
					<form action="t_userprofile.php" method="post" enctype="multipart/form-data">
						<select name="tailor_support" required="">
							<option value="" disabled selected hidden>Tailoring type</option>
	                    ...
	                    <br>
	                    <br>
	                    <input placeholder="Experience in years" name="experience" type="text" required="" pattern="[+0-9]{1,2}">
	                    <br>
	                    <br>
	                    <p align="center" class="p1">Profile picture:<input name="pic" type="file"></p>
						<br>
						<br>
	                    <p align="center" class="p1">Aadharcard:<input name="aadharcard" type="file" required=""></p>
	                    <br>
	                    <br>
	                    <hr>
	                    <br>
