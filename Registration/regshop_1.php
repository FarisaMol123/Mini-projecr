	...
	<div class="main">
		<div class="main-w3l">
			...
			<div class="w3layouts-main">
				<h2><span class="lohny">Owner Details</span></h2>
					<form action="regshop_2.php" method="post">
						<input placeholder="Owner name" name="name" type="text" required="" pattern="([^\s][A-Za-z\s]+)">
						<input placeholder="Email" name="email" type="email" required="" pattern="[a-z0-9._%+-]+@[a-z.-]+\.[a-z]{3,3}$" title="invalid mail format">
                      <input placeholder="contact number" name="phone_number" type="text" pattern="[+0-9]{13}" required="" onfocus="(this.value='+91')">
